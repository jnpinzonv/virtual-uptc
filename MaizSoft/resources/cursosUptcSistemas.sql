...
-- Grupo Profundizaci�n de Bases de datos
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
...
-- Grupo Simulaci�n por computador
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (31,1,25,0,9,8105529,16);
-- Grupo Metodologia de la Investigacion y Dise�o Experimental 
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
...
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (33,1,25,0,8,8105062,16);
-- Grupo Extension Rural
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (34,1,25,0,8,8105083,16);
-- Grupo Formulacion y Evaluacion de Proyectos
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (35,1,25,0,7,8105067,16);
-- Grupo Metodologia de la Investigacion
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (36,1,25,0,4,8108058,16);
-- Grupo Botanica Taxonomica
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (37,1,25,0,2,8108101,16);
-- Grupo Manejo Integral de Malezas
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (38,1,25,0,7,8105068,16);
-- Grupo Fisiologia Vegetal II
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (39,1,25,0,4,8108111,16);
-- Grupo Manejo Integral de Insectos
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (40,1,25,0,7,8105069,16);
-- Grupo Entomologia
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (41,1,25,0,6,8105063,16);
-- Grupo Bioestadistica y Dise�o Experimental
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (42,1,25,0,5,8108110,16);
-- Grupo Administracion Empresas Agropecuarias
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (43,1,25,0,6,8105057,16);
-- Grupo Econom�a agrar�a
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (44,1,25,0,5,8108054,16);
-- Grupo Gerencia Empresarial Rural
insert into grupo_curso(id_grupo, id_codigo_grupo, cupos, inscritos, semestre, id_curso_grupo,numero_total)
values (45,1,25,0,9,8106261,16);
