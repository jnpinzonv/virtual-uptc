...
/**
 * ChatMessage Class that carry the needed message details for the chat messages
 * @author Osama Oransa
 * @version 1.0
 * 2010
 */
...
public class ChatMessage implements Serializable {
	...
	public String toXML() {
		return "<chat_message><from_user>" + from_user
				+ "</from_user><from_user_name>" + from_user_name
				+ "</from_user_name><message>" + message
				+ "</message><message_type>" + messageType
				+ "</message_type></chat_message>";
	}
	public String toMultipleValues() {
		return from_user + "ø" + from_user_name + "ø" + message + "ø"
				+ messageType + "ø";
	}
