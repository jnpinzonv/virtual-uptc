 ...
 * en esta clase con lo referente al gestor de noticias, se comunica con la base
...
public class GestorNoticias implements Serializable {
	...
	/**
	 * Variable que almacena el identificador de la noticia Tipo de Dato Long
	 */
	private Long idNoticia;

	/**
	 * Variable que almacena el nombre de la noticia Tipo de Dato String
	 */
	private String nombreNoticia;

	/**
	 * Variable que almacena la descripcion de la noticia Tipo de Dato String
	 */
	 ...
	 * 
	 * @param idNoticia
	 *            El valor por establecer para idNoticia
	 */
	 ...
	 * 
	 * @param nombreNoticia
	 *            El valor por establecer para nombreNoticia
	 */
