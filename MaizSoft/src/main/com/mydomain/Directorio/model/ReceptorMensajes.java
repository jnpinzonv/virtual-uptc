 ...
 * receptores de los mensajes enviados y porteriormente recibidos. Modulo de
 * Desarrollo :CU- ...
 * 
...
public class ReceptorMensajes implements Serializable {
	...
	/**
	 * Variable encargada de almacenar el identificador del receptor de
	 * determinado mensaje.
	 */
	private Long idReceptormenajes;

	/**
	 * Variable en cargada de almacenar informaci�n con respecto a los
	 * usuarios del curso. Instancia de la clase Usuario.
	 */
	private Usuario userAccount;

	private boolean leido;
	/**
	 * Variable encargada de guardar informaci�n con respecto al env�o de
	 * mensajes en la plataformfa.
	 */
	 ...
	 * 
	 * @param idReceptormenajes
	 *            El valor por establecer para idReceptormenajes
	 */
	 ...
	 * 
	 * @param leido
	 *            El valor por establecer para leido
	 */
