 ...
 * los permiso de usuario. Modulo de Desarrollo :CU- ...
 * 
...
public class UserPermission implements Serializable {
	...
	/**
	 * Variable encargada de almacenar el identificador de los permisos de
	 * usuario.
	 */
	private Long id;
	/**
	 * Variable encargada de almacenar el nombre del beneficiario de los
	 * permisos de usuario.
	 */
	private String recipient;
	/**
	 * Variable que guarda el objetivo de los permisos.
	 */
	private String target;
	/**
	 * Variable que almacena el nombre de la acción de los permisos de usuario.
	 */
	private String action;
	/**
	 * Variable que almacena el nombre del discriminador de los permisos.
	 */
	 ...
	 * 
	 * @param recipient
	 *            El valor por establecer para recipient
	 */
	 ...
	 * 
	 * @param target
	 *            El valor por establecer para target
	 */
	 ...
	 * 
	 * @param action
	 *            El valor por establecer para action
	 */
	 ...
	 * 
	 * @param discriminator
	 *            El valor por establecer para discriminator
	 */
